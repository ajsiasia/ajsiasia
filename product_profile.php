...
<div class="w3-container">
	...
	<div class="w3-container w3-padding-large">
		...
		<footer class="w3-container w3-light-blue w3-padding-small">
			<a class="w3-button w3-round-large w3-yellow w3-margin" href="index.php?page=update&id=<?php echo $id ?>">Edit</a>
			<a class="w3-button w3-round-large w3-red w3-margin" href="pro_delete.php?id=<?php echo $id ?>">Delete</a>
		</footer>
	</div>
  </div>
</html>
